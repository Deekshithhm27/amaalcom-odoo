...
class HrPayslip(models.Model):
    ...
    def get_external_worked_day_lines(self, contracts, date_from, date_to):
        ...
        for contract in contracts.filtered(lambda contract: contract.resource_calendar_id):
            ...
            attendances = {
                ...
                'sequence': 1,
                'code': 'WORK100',
                'number_of_days': self.sal_track_id.worked_days,
    ...
    # Overriding standard function in order to make it work for external employees
    def onchange_employee_id(self, date_from, date_to, employee_id=False, contract_id=False):
        ...
        if not self.sal_track_id:
            ...
            worked_days_line_ids = self.get_external_worked_day_lines(contracts, date_from, date_to)
