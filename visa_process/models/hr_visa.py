...
class HrVisa(models.Model):
    ...
    def create(self, values):
        ...
        if res.sudo().employee_id.parent_id.user_id:
            partner.append(res.sudo().employee_id.parent_id.user_id.partner_id.id)
    ...
    # refer hr_expense_payment module in saudi hr
